...
module.exports = {
    ...
    async execute(client, interaction) {
        ...
        switch (option) {
            ...
            case 'pm':
                if (!interaction.member.roles.cache.find(e => e.name.includes('Head Moderator') || e.name.includes('Management Team') || e.name.includes('Bot Developer'))) return interaction.editReply({content: 'Nope', ephemeral: true})
